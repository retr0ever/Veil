  ...
  return (
    <div className="flex min-h-[240px] flex-col items-center justify-center px-6 py-14 text-center">
      ...
      <p className="mt-1.5 max-w-xs text-[14px] text-dim">
        Veil hasn't found any vulnerabilities yet. The AI agents will automatically scan your traffic for attack patterns and generate findings.
      </p>
    </div>
  )
}
...
/* ── Main panel ─────────────────────────────────────────── */
export function FindingsPanel({ siteId, findings, onFindingStatusChange }) {
